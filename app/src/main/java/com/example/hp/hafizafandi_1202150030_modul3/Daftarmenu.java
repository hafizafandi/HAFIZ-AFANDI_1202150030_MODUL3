...
pquestWindowFeature(Window.FEATURE_NO_TITLE);
        getWindoublic import java.util.ArrayList;
import java.util.List;

class Daftarmenu extends AppCompatActivity {
    RecyclerView recv;
    Adaptermenu adptr;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        this.rew().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
